...
The relevant brief sections for LinkedIn content are:
- `project` — name, one-liner, description, tech stack, key features
- `audience` — target users, ICP, pain points
- `hackathon` — name, theme, prize, team
- `narrative.*` — all narrative sections (problem, solution, why now, traction, market)
- `content_angles` — suggested angles for content
- `meta.repo_url` — GitHub link for CTA
- `meta.website` — website/landing page link
