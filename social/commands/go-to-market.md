...
Read `.social/project-brief.json` and use the `linkedin-content-strategy` skill. Follow these steps:
...
3. **Generate Slidev deck**:
   ```bash
   python3 ${CLAUDE_PLUGIN_ROOT}/skills/repo-to-fundraising-pitchdeck/scripts/generate_slidev_pitchdeck.py \
